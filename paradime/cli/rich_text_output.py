...
def print_cli_header(version: str) -> None:
    ...
    version_title.append(f'\n\nUse the Paradime CLI to login and trigger Bolt dbt schedules from the terminal.', style='#9696a0')
    version_title.append(f'\n\nRead examples of using the CLI and the SDK: ', style='#9696a0')
    version_title.append(f'https://github.com/paradime-io/paradime-python-sdk/tree/main/examples', style='underline #9696a0')
